...
class UciephyTestSpec extends AnyFlatSpec with ChiselScalatestTester {
  ...
  it should "work in manual test mode" in {
    test(new UciephyTestHarness).withAnnotations(Seq(VcsBackendAnnotation, WriteFsdbAnnotation)) { c =>
      ...
      c.io.mmio.txDataChunkIn.enqueueNow("h0000_0000_4321_def0".U)
      c.clock.step()
      c.io.mmio.txDataChunkOut.expect("h0000_0000_4321_def0".U)
      c.io.mmio.txDataOffset.poke(1.U)
      c.io.mmio.txDataChunkIn.enqueueNow("h0000_0000_8765_9abc".U)
      c.clock.step()
      c.io.mmio.txDataChunkOut.expect("h0000_0000_8765_9abc".U)
      c.io.mmio.txDataOffset.poke(2.U)
      c.io.mmio.txDataChunkIn.enqueueNow("h0000_0000_cba9_5678".U)
      c.clock.step()
      c.io.mmio.txDataChunkOut.expect("h0000_0000_cba9_5678".U)
      c.io.mmio.txDataOffset.poke(3.U)
      c.io.mmio.txDataChunkIn.enqueueNow("h0000_0000_0fed_1234".U)
      c.clock.step()
      c.io.mmio.txDataChunkOut.expect("h0000_0000_0fed_1234".U)
      c.io.mmio.txTestState.expect(TxTestState.idle)
      ...
      c.io.mmio.txDataChunkIn.enqueueNow("h0000_0000_0fed_1234".U)
      c.clock.step()
      c.io.mmio.txDataOffset.poke(4.U)
      c.io.mmio.txDataChunkIn.enqueueNow("h0000_0000_dea1_f00d".U)
      c.clock.step()
      c.io.mmio.txDataOffset.poke(5.U)
      c.io.mmio.txDataChunkIn.enqueueNow("h0000_0000_deed_cafe".U)
      c.clock.step()
      c.io.mmio.txTestState.expect(TxTestState.idle)
