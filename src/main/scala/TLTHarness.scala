...
class TLUCIePhyTester(implicit p: Parameters) extends LazyModule {
  ...
  val uciephyTopIO = BundleBridgeSink[uciephytest.UciephyTestTLIO]()
  uciephyTopIO := ucie.topIO
  ...
  class Impl extends LazyModuleImp(this) {
    ...
    // Loopback
    uciphyIO_0.common.phy.refClkP := clock.asBool
    uciphyIO_0.common.phy.refClkN := !clock.asBool
    uciphyIO_0.common.phy.bypassClkP := clock.asBool
    uciphyIO_0.common.phy.bypassClkN := !clock.asBool
    uciphyIO_0.common.phy.pllRdacVref := false.B
    uciphyIO_0.phy.rxClkP := uciphyIO_0.phy.txClkP
    uciphyIO_0.phy.rxClkN := uciphyIO_0.phy.txClkN
    uciphyIO_0.phy.rxValid := uciphyIO_0.phy.txValid
    uciphyIO_0.phy.rxTrack := uciphyIO_0.phy.txTrack
    uciphyIO_0.phy.rxData := uciphyIO_0.phy.txData
    uciphyIO_0.phy.sbRxClk := uciphyIO_0.phy.sbTxClk
    uciphyIO_0.phy.sbRxData := uciphyIO_0.phy.sbTxData
